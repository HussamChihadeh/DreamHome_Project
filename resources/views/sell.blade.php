        ...
        <div class="row mt-5 mb-5">
            ...
            <div class="col-lg-5">
                ...
                <div class="form-check form-check-inline mb-3">
                    <input class="form-check-input" type="radio" name="buy_or_rent" id="inlineRadio1" value="buy">
                    <label class="form-check-label" for="inlineRadio1">Buy</label>
                </div>
                <div class="form-check form-check-inline mb-3">
                    <input class="form-check-input" type="radio" name="buy_or_rent" id="inlineRadio2" value="rent">
            ...
            <div class="col-lg-5 ">
                ...
                <div style="border: 1px solid black; width: 250px; height: 300px; margin-top: 20px; margin-bottom: 20px;">
