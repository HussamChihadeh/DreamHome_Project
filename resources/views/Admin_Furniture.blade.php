...
<div class="row" style="height: 100%;">
            ...
            <div class="col-sm-6 col-12 p-2">
                <div class="Top_Container Information">
                    ...
                    <p>-This page shows the Properties that are listed for Rent/Sale, and you will need to assign
                        ...
                        <br>
                        -Input is an Integer<br>
                        -Press on quantity to edit (Restock )
                    </p>
                </div>
            </div>
        </div>
                ...
                success: function(properties) {
                    ...
                    $.each(properties.data, function(index, property) {
                        ...
                        tbody.innerHTML +=
                            ...
                            "<td>" + property.price.toLocaleString('en-US', {
                                style: 'currency',
                                currency: 'USD'
                            }) + "</td>" +
                            "<td>" + property.designer_id + "</td>" +
                            "<td onclick=\"makeEditable(this, 'property.quantity'," + property.id + ")\">" + property.quantity + "</td>" +
                            "<td> <button class='Request_View_Details' id='View_Details_" + property.id + "'>Details</button></td>" +
                            "<td id=\"quantity_${property.id}\" hidden>" + property.id + "</td>"+
                            "</tr>";
    ...
    <script>
        ...
        addItemBtn.addEventListener('click', () => {
            ...
            imageCell.innerHTML = `
                    <button class="choose-file-btn Request_View_Details">Choose File(s)</button>
            ...
            saveCell.innerHTML = '<button class="save-btn Request_View_Details">Save</button>';
        ...
        function makeEditable(element, dataKey, furniture_id) {
            ...
            inputElement.addEventListener("blur", function() {
                ...
                $.ajax({
                    url: '/api/v1/furniture/UpdateFurn',
                    type: 'PUT',
                    data: {
                        'id': furniture_id,
        ...
        // function updateDataValue(dataKey, updatedValue) {
        //     // You can handle the updated value here
        //     // For example, update the value in the data object or send it to the server
        //     console.log("Updated value for key '" + dataKey + "': " + updatedValue);
