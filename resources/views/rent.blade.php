      ...
      <div id="Filter_By_Province">
          ...
          <div class="d-flex align-items-center">
            <div class="form-check form-check-inline mb-3 d-flex align-items-center">
                <input class="form-check-input me-1" type="radio" name="buy_or_rent[eq]" id="inlineRadio1"
                    value="buy">
                <label class="form-check-label" for="inlineRadio1">Buy</label>
            </div>
            <div class="form-check form-check-inline mb-3 d-flex align-items-center">
                <input class="form-check-input me-1" type="radio" name="buy_or_rent[eq]" id="inlineRadio2"
                    value="rent">
            ...
            <a> <img src="IMAGES\image_logo.png" width="50" height="100"
                style="margin-top: 13; margin-left: -20; border-bottom-left-radius: 15px;"></a>
