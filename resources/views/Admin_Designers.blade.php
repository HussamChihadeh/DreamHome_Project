...
<div class="row" style="height: 100%;">
        ...
        <div class="Table_Container">
            <div class="Group_container " id="Group_container">
                <div class="pagination d-flex justify-content-between">
                    ...
                    <button id="add-item-btn" class="Add_Item_Button">add designer</button>
                ...
                success: function(designers) {
                    ...
                    $.each(designers.data, function(index, designer) {
                        tbody.innerHTML += "<tr>" +
                            ...
                            "<td><button id='delete_designer' class='Request_View_Details' data-id='" + designer.id + "'>Delete</button></td></tr>";
    ...
    <script>
        ...
        addItemBtn.addEventListener('click', () => {
            ...
            imageCell.innerHTML = `
                    <button class="choose-file-btn Request_View_Details" style="border-radius:10px" >Choose File</button>
        ...
        window.onload = function() {
            ...
            for (var i = 0; i < nav_items.length; i++) {
                if (nav_items[i].innerHTML.includes("Designers")) {
                    var link = nav_items[i].querySelector('a');
                    link.innerHTML = "Designers";
